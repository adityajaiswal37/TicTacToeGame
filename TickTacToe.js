...
function playerMove1(param){
    ...
    const inputElement1 = document.querySelector(".player1-name");
    var P1 = inputElement1.value;
    const inputElement2 = document.querySelector(".player2-name");
    var P2 = inputElement2.value;
